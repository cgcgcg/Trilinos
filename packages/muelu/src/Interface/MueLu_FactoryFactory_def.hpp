...
// *****************************************************************************
// @HEADER
#ifndef MUELU_FACTORYFACTORY_DEF_HPP
...
RCP<const FactoryBase> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildFactory(const Teuchos::ParameterEntry& param, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
  // Find factory
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
template <class T>
RCP<T> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::Build(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
...
RCP<T> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::Build2(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
  RCP<T> factory = rcp(new T());
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
template <class T>  // T must implement the Factory interface
RCP<T> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildRAPFactory(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
  RCP<T> factory;
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
template <class T>  // T must implement the Factory interface
RCP<T> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildTogglePFactory(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
  RCP<T> factory;
  if (paramList.isSublist("TransferFactories") == false) {
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<MueLu::ToggleCoordinatesTransferFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node> > FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildToggleCoordinatesTransferFactory(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<FactoryBase> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildTrilinosSmoother(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<FactoryBase> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildDirectSolver(const Teuchos::ParameterList& paramList, const FactoryMap& /* factoryMapIn */, const FactoryManagerMap& /* factoryManagersIn */) const {
  if (paramList.begin() == paramList.end())
...
#ifdef HAVE_MUELU_TEKO
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<FactoryBase> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildTekoSmoother(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
  // read in sub lists
  RCP<ParameterList> paramListNonConst = rcp(new ParameterList(paramList));
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
RCP<FactoryBase> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildBlockedDirectSolver(const Teuchos::ParameterList& paramList, const FactoryMap& /* factoryMapIn */, const FactoryManagerMap& /* factoryManagersIn */) const {
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
template <class T>  // T must implement the Factory interface
RCP<T> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildBlockedFactory(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
template <class T>  // T must implement the Factory interface
RCP<T> FactoryFactory<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BuildBlockedCoordFactory(const Teuchos::ParameterList& paramList, const FactoryMap& factoryMapIn, const FactoryManagerMap& factoryManagersIn) const {
  RCP<T> pfac = Teuchos::null;
