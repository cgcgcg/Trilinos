...
\cbb{aggregation: use aux matrix}{bool}{false}{Use a different matrix for aggregation. The matrix to be used for aggregation is passed via the "user data" list using the name "AggMatrix".}
...
\cbb{material: rtc function}{string}{"value = 1"}{Set material vector used by material weighted distance Laplacian aggregation via an RTC function.}
