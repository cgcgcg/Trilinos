...
typedef Tpetra::CrsMatrix<scalar_type, local_ordinal_type, global_ordinal_type,
                          node_type>
    crs_matrix_type;
typedef Tpetra::RowMatrix<scalar_type, local_ordinal_type, global_ordinal_type,
                          node_type>
    row_matrix_type;
...
typedef Xpetra::Matrix<scalar_type, local_ordinal_type, global_ordinal_type,
                       node_type>
    xpetra_matrix;
...
public:
  AdditiveVariant(RCP<crs_matrix_type>, RCP<multivector_type>,
                  DomainPartitioning);

  void apply(const multivector_type &, multivector_type &, Teuchos::ETransp,
             scalar_type, scalar_type) const;
