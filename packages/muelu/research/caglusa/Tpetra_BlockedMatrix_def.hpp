...
BlockedMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node>::BlockedMatrix(
    ...
    : pointA_(pointA), blockA_(blockA), blockMap_(blockMap),
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
void BlockedMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node>::apply(
...
template <class Scalar, class LocalOrdinal, class GlobalOrdinal, class Node>
void BlockedMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node>::localApply(
    const Tpetra::MultiVector<Scalar, LocalOrdinal, GlobalOrdinal, Node> &X,
    Tpetra::MultiVector<Scalar, LocalOrdinal, GlobalOrdinal, Node> &Y,
    Teuchos::ETransp mode, Scalar alpha, Scalar beta) const {
