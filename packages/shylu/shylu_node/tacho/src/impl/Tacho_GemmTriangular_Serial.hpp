...
// @HEADER
// clang-format on
#ifndef __TACHO_GEMM_TRIANGULAR_SERIAL_HPP__
#define __TACHO_GEMM_TRIANGULAR_SERIAL_HPP__
...
template <> struct GemmTriangular<Trans::Transpose, Trans::NoTranspose, Uplo::Upper, Algo::Serial> {
