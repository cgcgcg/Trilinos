...
/*! \file Ifpack2_UnitTestSparseApproximateInverse.cpp

\brief Ifpack2 Unit test for the sparse approximate inverse.
*/
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL(Ifpack2SparseApproximateInverse, Test0, Scalar, LocalOrdinal, GlobalOrdinal) {
  ...
  Ifpack2::SparseApproximateInverse<Tpetra::RowMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node> > prec(crsmatrix);
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL(Ifpack2SparseApproximateInverse, Test1, Scalar, LocalOrdinal, GlobalOrdinal) {
  // we are now in a class method declared by the above macro, and
  // that method has these input arguments:
  // Teuchos::FancyOStream& out, bool& success
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL(Ifpack2SparseApproximateInverse, Test3, Scalar, LocalOrdinal, GlobalOrdinal) {
  ...
  using prec_type = Ifpack2::SparseApproximateInverse<Tpetra::RowMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node> >;
  using mag_type  = decltype(prec_type(A).getDropTolerance());
...
#define UNIT_TEST_GROUP_SC_LO_GO(Scalar, LocalOrdinal, GlobalOrdinal)                                               \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(Ifpack2SparseApproximateInverse, Test0, Scalar, LocalOrdinal, GlobalOrdinal) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(Ifpack2SparseApproximateInverse, Test1, Scalar, LocalOrdinal, GlobalOrdinal) \
  TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(Ifpack2SparseApproximateInverse, Test3, Scalar, LocalOrdinal, GlobalOrdinal)
