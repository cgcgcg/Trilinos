...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    RCP<MyBetterOperator<ST> > A = rcp(new MyBetterOperator<ST>(dim, colptr, nnz, rowind, cvals));
    //
    ...
    //
    std::cout << "Belos::GmresPolySolMgr returned achievedTol: " << solver->achievedTol() << std::endl
              << std::endl;
    //
