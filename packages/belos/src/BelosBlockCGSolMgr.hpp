 ...
 *
 */
class BlockCGSolMgrLinearProblemFailure : public BelosError {
 public:
...
class BlockCGSolMgr : public Details::SolverManagerRequiresLapack<ScalarType, MV, OP, DM> {
...
class BlockCGSolMgr<ScalarType, MV, OP, DM, true> : public Details::SolverManagerRequiresLapack<ScalarType, MV, OP, DM, true> {
 private:
...
template <class ScalarType, class MV, class OP, class DM>
void BlockCGSolMgr<ScalarType, MV, OP, DM, true>::
