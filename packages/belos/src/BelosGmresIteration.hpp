 ...
 */
class GmresIterationInitFailure : public BelosError {
 public:
 ...
 *
 */
class GmresIterationOrthoFailure : public BelosError {
 public:
 ...
 *
 */
class GmresIterationLAPACKFailure : public BelosError {
 public:
