...
template <class ScalarType, class MV, class OP, class DM = DefaultDenseMatrix<int, ScalarType>>
class DGKSOrthoManager : public MatOrthoManager<ScalarType, MV, OP, DM> {
 private:
...
const typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType
    DGKSOrthoManager<ScalarType, MV, OP, DM>::blk_tol_default_ = 10 * Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::squareroot(
                                                                          Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::eps());

template <class ScalarType, class MV, class OP, class DM>
const typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType
    DGKSOrthoManager<ScalarType, MV, OP, DM>::dep_tol_default_ = Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::one() / Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::squareroot(
                                                                                                                                                                      2 * Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::one());

template <class ScalarType, class MV, class OP, class DM>
const typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType
    DGKSOrthoManager<ScalarType, MV, OP, DM>::sing_tol_default_ = 10 * Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::eps();
...
template <class ScalarType, class MV, class OP, class DM>
const typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType
    DGKSOrthoManager<ScalarType, MV, OP, DM>::blk_tol_fast_ = Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::zero();

template <class ScalarType, class MV, class OP, class DM>
const typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType
    DGKSOrthoManager<ScalarType, MV, OP, DM>::dep_tol_fast_ = Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::zero();

template <class ScalarType, class MV, class OP, class DM>
const typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType
    DGKSOrthoManager<ScalarType, MV, OP, DM>::sing_tol_fast_ = Teuchos::ScalarTraits<typename DGKSOrthoManager<ScalarType, MV, OP, DM>::MagnitudeType>::zero();
...
template <class ScalarType, class MV, class OP, class DM>
int DGKSOrthoManager<ScalarType, MV, OP, DM>::
    projectAndNormalizeWithMxImpl(MV &X,
                                  Teuchos::RCP<MV> MX,
                                  Teuchos::Array<Teuchos::RCP<DM>> C,
                                  Teuchos::RCP<DM> B,
...
// Routine to compute the block orthogonalization
template <class ScalarType, class MV, class OP, class DM>
bool DGKSOrthoManager<ScalarType, MV, OP, DM>::blkOrtho1(MV &X, Teuchos::RCP<MV> MX,
                                                         Teuchos::Array<Teuchos::RCP<DM>> C,
                                                         Teuchos::ArrayView<Teuchos::RCP<const MV>> Q) const {
  int nq               = Q.size();
  int xc               = MVT::GetNumberVecs(X);
...
// Routine to compute the block orthogonalization
template <class ScalarType, class MV, class OP, class DM>
bool DGKSOrthoManager<ScalarType, MV, OP, DM>::blkOrtho(MV &X, Teuchos::RCP<MV> MX,
                                                        Teuchos::Array<Teuchos::RCP<DM>> C,
                                                        Teuchos::ArrayView<Teuchos::RCP<const MV>> Q) const {
  int nq               = Q.size();
  int xc               = MVT::GetNumberVecs(X);
...
template <class ScalarType, class MV, class OP, class DM>
int DGKSOrthoManager<ScalarType, MV, OP, DM>::blkOrthoSing(MV &X, Teuchos::RCP<MV> MX,
                                                           Teuchos::Array<Teuchos::RCP<DM>> C,
                                                           Teuchos::RCP<DM> B,
                                                           Teuchos::ArrayView<Teuchos::RCP<const MV>> QQ) const {
