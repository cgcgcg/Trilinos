...
enum ReturnType : int {
  ...
  MaxRestartsReached = 3,
  /*!< Convergence was not reached because the maximum number of restarts was reached. */  // GMRES
  OrthonormFailure = 4,
  /*!< Convergence was not reached because the orthonormalization failed. */  // BlockCG
  NaNDetected       = 5,                                                      /*!< Convergence was not reached because a NaN was detected. */
  BreakdownDetected = 6,
  /*!< Convergence was not reached because a breakdown was detected. */  // BlockCG
  LossOfAccuracyDetected = 7,
  /*!< Convergence was not reached because loss of accuracty was detected. */  // GMRES
