...
template <class ScalarType, class MV, class OP, class DM>
class RealSolverManager<ScalarType, MV, OP, DM, false> : public SolverManager<ScalarType, MV, OP, DM> {
 public:
  RealSolverManager() {}
...
template <class ScalarType, class MV, class OP, class DM>
class RealSolverManager<ScalarType, MV, OP, DM, true> : public SolverManager<ScalarType, MV, OP, DM> {
 public:
  RealSolverManager() {
...
template <class ScalarType, class MV, class OP, class DM>
class SolverManagerRequiresLapack<ScalarType, MV, OP, DM, true> : public SolverManager<ScalarType, MV, OP, DM> {
 public:
...
/// constructor.
template <class ScalarType, class MV, class OP, class DM>
class SolverManagerRequiresLapack<ScalarType, MV, OP, DM, false> : public SolverManager<ScalarType, MV, OP, DM> {
 public:
  SolverManagerRequiresLapack() {
    TEUCHOS_TEST_FOR_EXCEPTION(true, std::logic_error,
...
/// SolverManager.
template <class ScalarType, class MV, class OP, class DM>
class SolverManagerRequiresRealLapack<ScalarType, MV, OP, DM, true> : public SolverManager<ScalarType, MV, OP, DM> {
 public:
...
/// constructor.
template <class ScalarType, class MV, class OP, class DM>
class SolverManagerRequiresRealLapack<ScalarType, MV, OP, DM, false> : public SolverManager<ScalarType, MV, OP, DM> {
 public:
  SolverManagerRequiresRealLapack() {
    // Do not throw on constructor. The DII system registers all class types
    // and must construct even if the class will not be usable.
