 ...
 *
 */
class PseudoBlockStochasticCGSolMgrLinearProblemFailure : public BelosError {
 public:
...
ReturnType PseudoBlockStochasticCGSolMgr<ScalarType, MV, OP, DM>::solve() {
  ...
  Teuchos::RCP<PseudoBlockStochasticCGIter<ScalarType, MV, OP, DM>> block_cg_iter = Teuchos::rcp(new PseudoBlockStochasticCGIter<ScalarType, MV, OP, DM>(problem_, printer_, outputTest_, plist));
