 ...
 */
class CGIterationInitFailure : public BelosError {
 public:
 ...
 *
 */
class CGIterateFailure : public BelosError {
 public:
 ...
 *
 */
class CGPositiveDefiniteFailure : public CGIterateFailure {
 public:
  CGPositiveDefiniteFailure(const std::string& what_arg)
    : CGIterateFailure(what_arg) {}
};
 ...
 *
 */
class CGIterationOrthoFailure : public BelosError {
 public:
 ...
 *
 */
class CGIterationLAPACKFailure : public BelosError {
 public:
