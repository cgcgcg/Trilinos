 ...
 *
 */
class PseudoBlockCGSolMgrLinearProblemFailure : public BelosError {
 public:
...
class PseudoBlockCGSolMgr : public Details::SolverManagerRequiresLapack<ScalarType, MV, OP, DM,
                                                                        Details::LapackSupportsScalar<ScalarType>::value> {
...
class PseudoBlockCGSolMgr<ScalarType, MV, OP, DM, true> : public Details::SolverManagerRequiresLapack<ScalarType, MV, OP, DM, true> {
 private:
