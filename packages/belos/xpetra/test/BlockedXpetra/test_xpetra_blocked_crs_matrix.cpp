...
int main(int argc, char *argv[]) {
  ...
  using DM = Belos::DefaultDenseMatrix<int, ST>;
  ...
  try {
    ...
    //
    Belos::LinearProblem<ST, MV, OP, DM> problem(belosOp, X, B);
    ...
    // *******************************************************************
    //
    Belos::BlockGmresSolMgr<ST, MV, OP, DM> solver(rcpFromRef(problem),
