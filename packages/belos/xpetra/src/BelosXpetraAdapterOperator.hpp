 ...
 */
class XpetraOpFailure : public BelosError {
 public:
...
template <class Scalar,
          ...
          class GlobalOrdinal,
          class Node>
class XpetraOp : public OperatorT<Xpetra::MultiVector<Scalar, LocalOrdinal, GlobalOrdinal, Node> >, public OperatorT<Tpetra::MultiVector<Scalar, LocalOrdinal, GlobalOrdinal, Node> > {
 public:
