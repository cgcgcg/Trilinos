 ...
 public:
  ...
  makeMatrix(const Teuchos::RCP<Teuchos::ParameterList>& params) {
    const std::string inputMatrixFilename =
        params->isType<std::string>("Input matrix filename") ? params->get<std::string>("Input matrix filename") : "";
    const std::string outputMatrixFilename =
        params->isType<std::string>("Output matrix filename") ? params->get<std::string>("Output matrix filename") : "";
    const global_ordinal_type globalNumRows =
        params->isType<global_ordinal_type>("Global number of rows") ? params->get<global_ordinal_type>("Global number of rows") : comm_->getSize() * 100;  // A sensible default
    const bool generated = params->isType<bool>("Generated") ? params->get<bool>("Generated") : inputMatrixFilename == "";
  ...
  makeVectors(const Teuchos::RCP<const sparse_matrix_type>& A,
    ...
    const std::string inRhsFilename =
        params->isType<std::string>("Input RHS filename") ? params->get<std::string>("Input RHS filename") : "";
    const std::string outRhsFilename =
        params->isType<std::string>("Output RHS filename") ? params->get<std::string>("Output RHS filename") : "";
