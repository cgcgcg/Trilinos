...
class TpetraOperator : public Tpetra::Operator<Scalar, LocalOrdinal, GlobalOrdinal, Node> {
 ...
 public:
  ...
  Teuchos::RCP<const Tpetra_Map> getDomainMap() const override { return lp_->getOperator()->getDomainMap(); };

  //! Return the range map for this operator.
  Teuchos::RCP<const Tpetra_Map> getRangeMap() const override { return lp_->getOperator()->getRangeMap(); };
  //@}
};
