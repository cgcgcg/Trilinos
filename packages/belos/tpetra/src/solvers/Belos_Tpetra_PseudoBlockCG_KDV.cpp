...
void register_PseudoBlockCG_KDV_tmpl(const bool verbose) {
...
void register_PseudoBlockCG_KDV(const bool verbose) {
  TPETRA_ETI_MANGLING_TYPEDEFS()

#ifdef BELOS_TPETRA_REGISTER_PSEUDOBLOCKCG_KDV
#undef BELOS_TPETRA_REGISTER_PSEUDOBLOCKCG_KDV
#endif  // BELOS_TPETRA_REGISTER_PSEUDOBLOCKCG_KDV
#define BELOS_TPETRA_REGISTER_PSEUDOBLOCKCG_KDV(SC, LO, GO, NT) register_PseudoBlockCG_KDV_tmpl<SC, LO, GO, NT>(verbose);

  TPETRA_INSTANTIATE_SLGN_NO_ORDINAL_SCALAR(BELOS_TPETRA_REGISTER_PSEUDOBLOCKCG_KDV)
