...
namespace ErrMsgs {
static constexpr char linearProblemNotSet[] =
    "The linear problem has not "
    "yet been set.  Please call setProblem with a nonnull argument before "
    "calling this method.";
static constexpr char solverNull[] =
    "The solver implementation (solver_) "
...
class SolverManagerBase : public Belos::SolverManager<SC, MV, OP, Teuchos::SerialDenseMatrix<int, SC>> {
 ...
 public:
  ...
  SolverManagerBase(const Teuchos::RCP<Krylov<SC, MV, OP>>& solver,
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(solver.get() == nullptr, std::invalid_argument, prefix << ErrMsgs::solverNull);
  ...
  const linear_problem_type& getProblem() const override {
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(this->problem_.get() == nullptr, std::runtime_error,
  ...
  Teuchos::RCP<const Teuchos::ParameterList> getValidParameters() const override {
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(this->solver_.get() == nullptr, std::logic_error, prefix << ErrMsgs::solverNull);
  ...
  Belos::ReturnType solve() override {
    ...
    TEUCHOS_TEST_FOR_EXCEPTION(this->solver_.get() == nullptr, std::logic_error,
                               prefix << ErrMsgs::solverNull);
    TEUCHOS_TEST_FOR_EXCEPTION(this->problem_.is_null(), std::runtime_error,
                               prefix << ErrMsgs::linearProblemNotSet);
