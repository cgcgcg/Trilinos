...
void register_TFQMR_KDV_tmpl(const bool verbose) {
...
void register_TFQMR_KDV(const bool verbose) {
  TPETRA_ETI_MANGLING_TYPEDEFS()

#ifdef BELOS_TPETRA_REGISTER_TFQMR_KDV
#undef BELOS_TPETRA_REGISTER_TFQMR_KDV
#endif  // BELOS_TPETRA_REGISTER_TFQMR_KDV
#define BELOS_TPETRA_REGISTER_TFQMR_KDV(SC, LO, GO, NT) register_TFQMR_KDV_tmpl<SC, LO, GO, NT>(verbose);

  TPETRA_INSTANTIATE_SLGN_NO_ORDINAL_SCALAR(BELOS_TPETRA_REGISTER_TFQMR_KDV)
