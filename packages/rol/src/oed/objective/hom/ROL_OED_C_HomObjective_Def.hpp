...
template<typename Real>
Real C_Objective<Real>::value( const Vector<Real> &z, Tolerance<Real> &tol ) {
...
template<typename Real>
void C_Objective<Real>::gradient( Vector<Real> &g, const Vector<Real> &z, Tolerance<Real> &tol ) {
  // Solve state equation
  ObjectiveBase<Real,std::vector<Real>>::solve_state_equation(pnull_,z,tol);
  Vector<Real> &state = *ObjectiveBase<Real,std::vector<Real>>::getState();
  // Build gradient
...
template<typename Real>
void C_Objective<Real>::hessVec( Vector<Real> &hv, const Vector<Real> &v, const Vector<Real> &z, Tolerance<Real> &tol ) {
  // Solve state equation
  ObjectiveBase<Real,std::vector<Real>>::solve_state_equation(pnull_,z,tol);
  Vector<Real> &state = *ObjectiveBase<Real,std::vector<Real>>::getState();
