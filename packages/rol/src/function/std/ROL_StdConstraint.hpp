...
public:
  ...
  virtual void value( std::vector<Real> &c, const std::vector<Real> &x, Tolerance<Real> &tol ) = 0;
  ...
  void applyPreconditioner(Vector<Real> &pv, const Vector<Real> &v, const Vector<Real> &x,
                           const Vector<Real> &g, Tolerance<Real> &tol) override;
  virtual void applyPreconditioner( std::vector<Real> &pv, const std::vector<Real> &v,
                                    const std::vector<Real> &x, const std::vector<Real> &g, Tolerance<Real> &tol );
