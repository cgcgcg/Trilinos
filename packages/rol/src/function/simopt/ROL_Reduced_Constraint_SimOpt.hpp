...
private:
  ...
  */
  void solve_adjoint_equation(const Vector<Real> &w, const Vector<Real> &z, Tolerance<Real> &tol);
  ...
  */
  void solve_adjoint_sensitivity(const Vector<Real> &w, const Vector<Real> &v, const Vector<Real> &z, Tolerance<Real> &tol);
...
public:
  ...
  */
  void value( Vector<Real> &c, const Vector<Real> &z, Tolerance<Real> &tol );
