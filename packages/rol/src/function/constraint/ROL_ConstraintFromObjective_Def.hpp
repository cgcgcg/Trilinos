...
template<typename Real>
void ConstraintFromObjective<Real>::value( Vector<Real>& c, const Vector<Real>& x, Tolerance<Real>& tol ) {
  setValue(c, obj_->value(x,tol) - offset_ );
}

template<typename Real>
void ConstraintFromObjective<Real>::applyJacobian( Vector<Real>& jv, const Vector<Real>& v, const Vector<Real>& x, Tolerance<Real>& tol ) {
...
template<typename Real>
void ConstraintFromObjective<Real>::applyAdjointJacobian( Vector<Real>& ajv, const Vector<Real>& v, const Vector<Real>& x, Tolerance<Real>& tol ) {
  obj_->gradient(ajv,x,tol);
  ajv.scale(getValue(v));
}

template<typename Real>
void ConstraintFromObjective<Real>::applyAdjointHessian( Vector<Real>& ahuv, const Vector<Real>& u, const Vector<Real>& v, const Vector<Real>& x, Tolerance<Real>& tol ) {
