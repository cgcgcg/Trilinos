...
{
	{ // std::type_info file:typeinfo line:88
		pybind11::class_<std::type_info, std::shared_ptr<std::type_info>, PyCallBack_std_type_info> cl(M("std"), "type_info", "");
	...
	{ // std::bad_cast file:typeinfo line:187
		pybind11::class_<std::bad_cast, std::shared_ptr<std::bad_cast>, PyCallBack_std_bad_cast, std::exception> cl(M("std"), "bad_cast", "");
