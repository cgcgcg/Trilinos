...
void bind_std_sstream_tcc(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // std::basic_istringstream file:bits/sstream.tcc line:292
		pybind11::class_<std::istringstream, std::shared_ptr<std::istringstream>, std::istream> cl(M("std"), "istringstream", "");
	...
	{ // std::basic_ostringstream file:bits/sstream.tcc line:293
		pybind11::class_<std::ostringstream, std::shared_ptr<std::ostringstream>> cl(M("std"), "ostringstream", "");
