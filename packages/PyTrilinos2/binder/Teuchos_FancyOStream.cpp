...
void bind_Teuchos_FancyOStream(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Teuchos::basic_FancyOStream file:Teuchos_FancyOStream.hpp line:381
		pybind11::class_<Teuchos::basic_FancyOStream<char,std::char_traits<char>>, Teuchos::RCP<Teuchos::basic_FancyOStream<char,std::char_traits<char>>>> cl(M("Teuchos"), "basic_FancyOStream_char_std_char_traits_char_t", "");
	...
	{ // Teuchos::basic_OSTab file:Teuchos_FancyOStream.hpp line:653
		pybind11::class_<Teuchos::basic_OSTab<char,std::char_traits<char>>, Teuchos::RCP<Teuchos::basic_OSTab<char,std::char_traits<char>>>> cl(M("Teuchos"), "basic_OSTab_char_std_char_traits_char_t", "");
		cl.def( pybind11::init( [](const class Teuchos::RCP<class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > > & a0){ return new Teuchos::basic_OSTab<char,std::char_traits<char>>(a0); } ), "doc" , pybind11::arg("fancyOStream"));
		cl.def( pybind11::init( [](const class Teuchos::RCP<class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > > & a0, const int & a1){ return new Teuchos::basic_OSTab<char,std::char_traits<char>>(a0, a1); } ), "doc" , pybind11::arg("fancyOStream"), pybind11::arg("tabs"));
		cl.def( pybind11::init<const class Teuchos::RCP<class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > > &, const int, const std::string>(), pybind11::arg("fancyOStream"), pybind11::arg("tabs"), pybind11::arg("linePrefix") );

		cl.def( pybind11::init( [](class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & a0){ return new Teuchos::basic_OSTab<char,std::char_traits<char>>(a0); } ), "doc" , pybind11::arg("fancyOStream"));
		cl.def( pybind11::init( [](class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & a0, const int & a1){ return new Teuchos::basic_OSTab<char,std::char_traits<char>>(a0, a1); } ), "doc" , pybind11::arg("fancyOStream"), pybind11::arg("tabs"));
		cl.def( pybind11::init<class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &, const int, const std::string>(), pybind11::arg("fancyOStream"), pybind11::arg("tabs"), pybind11::arg("linePrefix") );

		cl.def( pybind11::init( [](Teuchos::basic_OSTab<char,std::char_traits<char>> const &o){ return new Teuchos::basic_OSTab<char,std::char_traits<char>>(o); } ) );
		cl.def("assign", (class Teuchos::basic_OSTab<char, struct std::char_traits<char> > & (Teuchos::basic_OSTab<char,std::char_traits<char>>::*)(const class Teuchos::basic_OSTab<char, struct std::char_traits<char> > &)) &Teuchos::basic_OSTab<char, std::char_traits<char> >::operator=, "C++: Teuchos::basic_OSTab<char, std::char_traits<char> >::operator=(const class Teuchos::basic_OSTab<char, struct std::char_traits<char> > &) --> class Teuchos::basic_OSTab<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("osTab"));
		cl.def("incrTab", [](Teuchos::basic_OSTab<char,std::char_traits<char>> &o) -> Teuchos::basic_OSTab<char, struct std::char_traits<char> > & { return o.incrTab(); }, "", pybind11::return_value_policy::automatic);
		cl.def("incrTab", (class Teuchos::basic_OSTab<char, struct std::char_traits<char> > & (Teuchos::basic_OSTab<char,std::char_traits<char>>::*)(const int)) &Teuchos::basic_OSTab<char, std::char_traits<char> >::incrTab, "C++: Teuchos::basic_OSTab<char, std::char_traits<char> >::incrTab(const int) --> class Teuchos::basic_OSTab<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("tabs"));
		cl.def("o", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > & (Teuchos::basic_OSTab<char,std::char_traits<char>>::*)() const) &Teuchos::basic_OSTab<char, std::char_traits<char> >::o, "C++: Teuchos::basic_OSTab<char, std::char_traits<char> >::o() const --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > &", pybind11::return_value_policy::automatic);
		cl.def("get", (class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > * (Teuchos::basic_OSTab<char,std::char_traits<char>>::*)() const) &Teuchos::basic_OSTab<char, std::char_traits<char> >::get, "C++: Teuchos::basic_OSTab<char, std::char_traits<char> >::get() const --> class Teuchos::basic_FancyOStream<char, struct std::char_traits<char> > *", pybind11::return_value_policy::automatic);
	}
	{ // Teuchos::LabeledObject file:Teuchos_LabeledObject.hpp line:69
	...
	{ // Teuchos::DescribableStreamManipulatorState file:Teuchos_Describable.hpp line:175
		pybind11::class_<Teuchos::DescribableStreamManipulatorState, Teuchos::RCP<Teuchos::DescribableStreamManipulatorState>> cl(M("Teuchos"), "DescribableStreamManipulatorState", "");
	...
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		pybind11::class_<Teuchos::Array<std::string>, Teuchos::RCP<Teuchos::Array<std::string>>> cl(M("Teuchos"), "Array_std_string_t", "");
	...
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		pybind11::class_<Teuchos::Array<double>, Teuchos::RCP<Teuchos::Array<double>>> cl(M("Teuchos"), "Array_double_t", "");
		...
		cl.def("view", (class Teuchos::ArrayView<double> (Teuchos::Array<double>::*)(long, long)) &Teuchos::Array<double>::view, "C++: Teuchos::Array<double>::view(long, long) --> class Teuchos::ArrayView<double>", pybind11::arg("offset"), pybind11::arg("size_in"));
		cl.def("__call__", (class Teuchos::ArrayView<double> (Teuchos::Array<double>::*)(long, long)) &Teuchos::Array<double>::operator(), "C++: Teuchos::Array<double>::operator()(long, long) --> class Teuchos::ArrayView<double>", pybind11::arg("offset"), pybind11::arg("size"));
		cl.def("__call__", (class Teuchos::ArrayView<double> (Teuchos::Array<double>::*)()) &Teuchos::Array<double>::operator(), "C++: Teuchos::Array<double>::operator()() --> class Teuchos::ArrayView<double>");

		cl.def("__str__", [](Teuchos::Array<double> const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		pybind11::class_<Teuchos::Array<int>, Teuchos::RCP<Teuchos::Array<int>>> cl(M("Teuchos"), "Array_int_t", "");
		cl.def( pybind11::init( [](){ return new Teuchos::Array<int>(); } ) );
		cl.def( pybind11::init( [](long const & a0){ return new Teuchos::Array<int>(a0); } ), "doc" , pybind11::arg("n"));
		cl.def( pybind11::init<long, const int &>(), pybind11::arg("n"), pybind11::arg("value") );

		cl.def( pybind11::init( [](Teuchos::Array<int> const &o){ return new Teuchos::Array<int>(o); } ) );
		cl.def( pybind11::init<const class Teuchos::ArrayView<const int> &>(), pybind11::arg("a") );

		cl.def("assign", (class Teuchos::Array<int> & (Teuchos::Array<int>::*)(const class Teuchos::Array<int> &)) &Teuchos::Array<int>::operator=, "C++: Teuchos::Array<int>::operator=(const class Teuchos::Array<int> &) --> class Teuchos::Array<int> &", pybind11::return_value_policy::automatic, pybind11::arg("a"));
		cl.def("assign", (void (Teuchos::Array<int>::*)(long, const int &)) &Teuchos::Array<int>::assign, "C++: Teuchos::Array<int>::assign(long, const int &) --> void", pybind11::arg("n"), pybind11::arg("val"));
		cl.def("size", (long (Teuchos::Array<int>::*)() const) &Teuchos::Array<int>::size, "C++: Teuchos::Array<int>::size() const --> long");
		cl.def("max_size", (long (Teuchos::Array<int>::*)() const) &Teuchos::Array<int>::max_size, "C++: Teuchos::Array<int>::max_size() const --> long");
		cl.def("resize", [](Teuchos::Array<int> &o, long const & a0) -> void { return o.resize(a0); }, "", pybind11::arg("new_size"));
		cl.def("resize", (void (Teuchos::Array<int>::*)(long, const int &)) &Teuchos::Array<int>::resize, "C++: Teuchos::Array<int>::resize(long, const int &) --> void", pybind11::arg("new_size"), pybind11::arg("x"));
		cl.def("capacity", (long (Teuchos::Array<int>::*)() const) &Teuchos::Array<int>::capacity, "C++: Teuchos::Array<int>::capacity() const --> long");
		cl.def("empty", (bool (Teuchos::Array<int>::*)() const) &Teuchos::Array<int>::empty, "C++: Teuchos::Array<int>::empty() const --> bool");
		cl.def("reserve", (void (Teuchos::Array<int>::*)(long)) &Teuchos::Array<int>::reserve, "C++: Teuchos::Array<int>::reserve(long) --> void", pybind11::arg("n"));
		cl.def("__getitem__", (int & (Teuchos::Array<int>::*)(long)) &Teuchos::Array<int>::operator[], "C++: Teuchos::Array<int>::operator[](long) --> int &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("at", (int & (Teuchos::Array<int>::*)(long)) &Teuchos::Array<int>::at, "C++: Teuchos::Array<int>::at(long) --> int &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("front", (int & (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::front, "C++: Teuchos::Array<int>::front() --> int &", pybind11::return_value_policy::automatic);
		cl.def("back", (int & (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::back, "C++: Teuchos::Array<int>::back() --> int &", pybind11::return_value_policy::automatic);
		cl.def("push_back", (void (Teuchos::Array<int>::*)(const int &)) &Teuchos::Array<int>::push_back, "C++: Teuchos::Array<int>::push_back(const int &) --> void", pybind11::arg("x"));
		cl.def("pop_back", (void (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::pop_back, "C++: Teuchos::Array<int>::pop_back() --> void");
		cl.def("swap", (void (Teuchos::Array<int>::*)(class Teuchos::Array<int> &)) &Teuchos::Array<int>::swap, "C++: Teuchos::Array<int>::swap(class Teuchos::Array<int> &) --> void", pybind11::arg("x"));
		cl.def("clear", (void (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::clear, "C++: Teuchos::Array<int>::clear() --> void");
		cl.def("append", (class Teuchos::Array<int> & (Teuchos::Array<int>::*)(const int &)) &Teuchos::Array<int>::append, "C++: Teuchos::Array<int>::append(const int &) --> class Teuchos::Array<int> &", pybind11::return_value_policy::automatic, pybind11::arg("x"));
		cl.def("remove", (void (Teuchos::Array<int>::*)(int)) &Teuchos::Array<int>::remove, "C++: Teuchos::Array<int>::remove(int) --> void", pybind11::arg("i"));
		cl.def("length", (int (Teuchos::Array<int>::*)() const) &Teuchos::Array<int>::length, "C++: Teuchos::Array<int>::length() const --> int");
		cl.def("toString", (std::string (Teuchos::Array<int>::*)() const) &Teuchos::Array<int>::toString, "C++: Teuchos::Array<int>::toString() const --> std::string");
		cl.def_static("hasBoundsChecking", (bool (*)()) &Teuchos::Array<int>::hasBoundsChecking, "C++: Teuchos::Array<int>::hasBoundsChecking() --> bool");
		cl.def("getRawPtr", (int * (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::getRawPtr, "C++: Teuchos::Array<int>::getRawPtr() --> int *", pybind11::return_value_policy::automatic);
		cl.def("data", (int * (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::data, "C++: Teuchos::Array<int>::data() --> int *", pybind11::return_value_policy::automatic);
		cl.def("view", (class Teuchos::ArrayView<int> (Teuchos::Array<int>::*)(long, long)) &Teuchos::Array<int>::view, "C++: Teuchos::Array<int>::view(long, long) --> class Teuchos::ArrayView<int>", pybind11::arg("offset"), pybind11::arg("size_in"));
		cl.def("__call__", (class Teuchos::ArrayView<int> (Teuchos::Array<int>::*)(long, long)) &Teuchos::Array<int>::operator(), "C++: Teuchos::Array<int>::operator()(long, long) --> class Teuchos::ArrayView<int>", pybind11::arg("offset"), pybind11::arg("size"));
		cl.def("__call__", (class Teuchos::ArrayView<int> (Teuchos::Array<int>::*)()) &Teuchos::Array<int>::operator(), "C++: Teuchos::Array<int>::operator()() --> class Teuchos::ArrayView<int>");

		cl.def("__str__", [](Teuchos::Array<int> const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		pybind11::class_<Teuchos::Array<char>, Teuchos::RCP<Teuchos::Array<char>>> cl(M("Teuchos"), "Array_char_t", "");
		cl.def( pybind11::init( [](){ return new Teuchos::Array<char>(); } ) );
		cl.def( pybind11::init( [](long const & a0){ return new Teuchos::Array<char>(a0); } ), "doc" , pybind11::arg("n"));
		cl.def( pybind11::init<long, const char &>(), pybind11::arg("n"), pybind11::arg("value") );

		cl.def( pybind11::init( [](Teuchos::Array<char> const &o){ return new Teuchos::Array<char>(o); } ) );
		cl.def( pybind11::init<const class Teuchos::ArrayView<const char> &>(), pybind11::arg("a") );

		cl.def("assign", (class Teuchos::Array<char> & (Teuchos::Array<char>::*)(const class Teuchos::Array<char> &)) &Teuchos::Array<char>::operator=, "C++: Teuchos::Array<char>::operator=(const class Teuchos::Array<char> &) --> class Teuchos::Array<char> &", pybind11::return_value_policy::automatic, pybind11::arg("a"));
		cl.def("assign", (void (Teuchos::Array<char>::*)(long, const char &)) &Teuchos::Array<char>::assign, "C++: Teuchos::Array<char>::assign(long, const char &) --> void", pybind11::arg("n"), pybind11::arg("val"));
		cl.def("size", (long (Teuchos::Array<char>::*)() const) &Teuchos::Array<char>::size, "C++: Teuchos::Array<char>::size() const --> long");
		cl.def("max_size", (long (Teuchos::Array<char>::*)() const) &Teuchos::Array<char>::max_size, "C++: Teuchos::Array<char>::max_size() const --> long");
		cl.def("resize", [](Teuchos::Array<char> &o, long const & a0) -> void { return o.resize(a0); }, "", pybind11::arg("new_size"));
		cl.def("resize", (void (Teuchos::Array<char>::*)(long, const char &)) &Teuchos::Array<char>::resize, "C++: Teuchos::Array<char>::resize(long, const char &) --> void", pybind11::arg("new_size"), pybind11::arg("x"));
		cl.def("capacity", (long (Teuchos::Array<char>::*)() const) &Teuchos::Array<char>::capacity, "C++: Teuchos::Array<char>::capacity() const --> long");
		cl.def("empty", (bool (Teuchos::Array<char>::*)() const) &Teuchos::Array<char>::empty, "C++: Teuchos::Array<char>::empty() const --> bool");
		cl.def("reserve", (void (Teuchos::Array<char>::*)(long)) &Teuchos::Array<char>::reserve, "C++: Teuchos::Array<char>::reserve(long) --> void", pybind11::arg("n"));
		cl.def("__getitem__", (char & (Teuchos::Array<char>::*)(long)) &Teuchos::Array<char>::operator[], "C++: Teuchos::Array<char>::operator[](long) --> char &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("at", (char & (Teuchos::Array<char>::*)(long)) &Teuchos::Array<char>::at, "C++: Teuchos::Array<char>::at(long) --> char &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("front", (char & (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::front, "C++: Teuchos::Array<char>::front() --> char &", pybind11::return_value_policy::automatic);
		cl.def("back", (char & (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::back, "C++: Teuchos::Array<char>::back() --> char &", pybind11::return_value_policy::automatic);
		cl.def("push_back", (void (Teuchos::Array<char>::*)(const char &)) &Teuchos::Array<char>::push_back, "C++: Teuchos::Array<char>::push_back(const char &) --> void", pybind11::arg("x"));
		cl.def("pop_back", (void (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::pop_back, "C++: Teuchos::Array<char>::pop_back() --> void");
		cl.def("swap", (void (Teuchos::Array<char>::*)(class Teuchos::Array<char> &)) &Teuchos::Array<char>::swap, "C++: Teuchos::Array<char>::swap(class Teuchos::Array<char> &) --> void", pybind11::arg("x"));
		cl.def("clear", (void (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::clear, "C++: Teuchos::Array<char>::clear() --> void");
		cl.def("append", (class Teuchos::Array<char> & (Teuchos::Array<char>::*)(const char &)) &Teuchos::Array<char>::append, "C++: Teuchos::Array<char>::append(const char &) --> class Teuchos::Array<char> &", pybind11::return_value_policy::automatic, pybind11::arg("x"));
		cl.def("remove", (void (Teuchos::Array<char>::*)(int)) &Teuchos::Array<char>::remove, "C++: Teuchos::Array<char>::remove(int) --> void", pybind11::arg("i"));
		cl.def("length", (int (Teuchos::Array<char>::*)() const) &Teuchos::Array<char>::length, "C++: Teuchos::Array<char>::length() const --> int");
		cl.def("toString", (std::string (Teuchos::Array<char>::*)() const) &Teuchos::Array<char>::toString, "C++: Teuchos::Array<char>::toString() const --> std::string");
		cl.def_static("hasBoundsChecking", (bool (*)()) &Teuchos::Array<char>::hasBoundsChecking, "C++: Teuchos::Array<char>::hasBoundsChecking() --> bool");
		cl.def("getRawPtr", (char * (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::getRawPtr, "C++: Teuchos::Array<char>::getRawPtr() --> char *", pybind11::return_value_policy::automatic);
		cl.def("data", (char * (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::data, "C++: Teuchos::Array<char>::data() --> char *", pybind11::return_value_policy::automatic);
		cl.def("view", (class Teuchos::ArrayView<char> (Teuchos::Array<char>::*)(long, long)) &Teuchos::Array<char>::view, "C++: Teuchos::Array<char>::view(long, long) --> class Teuchos::ArrayView<char>", pybind11::arg("offset"), pybind11::arg("size"));
		cl.def("__call__", (class Teuchos::ArrayView<char> (Teuchos::Array<char>::*)(long, long)) &Teuchos::Array<char>::operator(), "C++: Teuchos::Array<char>::operator()(long, long) --> class Teuchos::ArrayView<char>", pybind11::arg("offset"), pybind11::arg("size"));
		cl.def("__call__", (class Teuchos::ArrayView<char> (Teuchos::Array<char>::*)()) &Teuchos::Array<char>::operator(), "C++: Teuchos::Array<char>::operator()() --> class Teuchos::ArrayView<char>");

		cl.def("__str__", [](Teuchos::Array<char> const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	{ // Teuchos::Array file:Teuchos_Array.hpp line:194
		pybind11::class_<Teuchos::Array<long long>, Teuchos::RCP<Teuchos::Array<long long>>> cl(M("Teuchos"), "Array_long_long_t", "");
		cl.def( pybind11::init( [](){ return new Teuchos::Array<long long>(); } ) );
		cl.def( pybind11::init( [](long const & a0){ return new Teuchos::Array<long long>(a0); } ), "doc" , pybind11::arg("n"));
		cl.def( pybind11::init<long, const long long &>(), pybind11::arg("n"), pybind11::arg("value") );

		cl.def( pybind11::init( [](Teuchos::Array<long long> const &o){ return new Teuchos::Array<long long>(o); } ) );
		cl.def( pybind11::init<const class Teuchos::ArrayView<const long long> &>(), pybind11::arg("a") );

		cl.def("assign", (class Teuchos::Array<long long> & (Teuchos::Array<long long>::*)(const class Teuchos::Array<long long> &)) &Teuchos::Array<long long>::operator=, "C++: Teuchos::Array<long long>::operator=(const class Teuchos::Array<long long> &) --> class Teuchos::Array<long long> &", pybind11::return_value_policy::automatic, pybind11::arg("a"));
		cl.def("assign", (void (Teuchos::Array<long long>::*)(long, const long long &)) &Teuchos::Array<long long>::assign, "C++: Teuchos::Array<long long>::assign(long, const long long &) --> void", pybind11::arg("n"), pybind11::arg("val"));
		cl.def("size", (long (Teuchos::Array<long long>::*)() const) &Teuchos::Array<long long>::size, "C++: Teuchos::Array<long long>::size() const --> long");
		cl.def("max_size", (long (Teuchos::Array<long long>::*)() const) &Teuchos::Array<long long>::max_size, "C++: Teuchos::Array<long long>::max_size() const --> long");
		cl.def("resize", [](Teuchos::Array<long long> &o, long const & a0) -> void { return o.resize(a0); }, "", pybind11::arg("new_size"));
		cl.def("resize", (void (Teuchos::Array<long long>::*)(long, const long long &)) &Teuchos::Array<long long>::resize, "C++: Teuchos::Array<long long>::resize(long, const long long &) --> void", pybind11::arg("new_size"), pybind11::arg("x"));
		cl.def("capacity", (long (Teuchos::Array<long long>::*)() const) &Teuchos::Array<long long>::capacity, "C++: Teuchos::Array<long long>::capacity() const --> long");
		cl.def("empty", (bool (Teuchos::Array<long long>::*)() const) &Teuchos::Array<long long>::empty, "C++: Teuchos::Array<long long>::empty() const --> bool");
		cl.def("reserve", (void (Teuchos::Array<long long>::*)(long)) &Teuchos::Array<long long>::reserve, "C++: Teuchos::Array<long long>::reserve(long) --> void", pybind11::arg("n"));
		cl.def("__getitem__", (long long & (Teuchos::Array<long long>::*)(long)) &Teuchos::Array<long long>::operator[], "C++: Teuchos::Array<long long>::operator[](long) --> long long &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("at", (long long & (Teuchos::Array<long long>::*)(long)) &Teuchos::Array<long long>::at, "C++: Teuchos::Array<long long>::at(long) --> long long &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("front", (long long & (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::front, "C++: Teuchos::Array<long long>::front() --> long long &", pybind11::return_value_policy::automatic);
		cl.def("back", (long long & (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::back, "C++: Teuchos::Array<long long>::back() --> long long &", pybind11::return_value_policy::automatic);
		cl.def("push_back", (void (Teuchos::Array<long long>::*)(const long long &)) &Teuchos::Array<long long>::push_back, "C++: Teuchos::Array<long long>::push_back(const long long &) --> void", pybind11::arg("x"));
		cl.def("pop_back", (void (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::pop_back, "C++: Teuchos::Array<long long>::pop_back() --> void");
		cl.def("swap", (void (Teuchos::Array<long long>::*)(class Teuchos::Array<long long> &)) &Teuchos::Array<long long>::swap, "C++: Teuchos::Array<long long>::swap(class Teuchos::Array<long long> &) --> void", pybind11::arg("x"));
		cl.def("clear", (void (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::clear, "C++: Teuchos::Array<long long>::clear() --> void");
		cl.def("append", (class Teuchos::Array<long long> & (Teuchos::Array<long long>::*)(const long long &)) &Teuchos::Array<long long>::append, "C++: Teuchos::Array<long long>::append(const long long &) --> class Teuchos::Array<long long> &", pybind11::return_value_policy::automatic, pybind11::arg("x"));
		cl.def("remove", (void (Teuchos::Array<long long>::*)(int)) &Teuchos::Array<long long>::remove, "C++: Teuchos::Array<long long>::remove(int) --> void", pybind11::arg("i"));
		cl.def("length", (int (Teuchos::Array<long long>::*)() const) &Teuchos::Array<long long>::length, "C++: Teuchos::Array<long long>::length() const --> int");
		cl.def("toString", (std::string (Teuchos::Array<long long>::*)() const) &Teuchos::Array<long long>::toString, "C++: Teuchos::Array<long long>::toString() const --> std::string");
		cl.def_static("hasBoundsChecking", (bool (*)()) &Teuchos::Array<long long>::hasBoundsChecking, "C++: Teuchos::Array<long long>::hasBoundsChecking() --> bool");
		cl.def("getRawPtr", (long long * (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::getRawPtr, "C++: Teuchos::Array<long long>::getRawPtr() --> long long *", pybind11::return_value_policy::automatic);
		cl.def("data", (long long * (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::data, "C++: Teuchos::Array<long long>::data() --> long long *", pybind11::return_value_policy::automatic);
		cl.def("view", (class Teuchos::ArrayView<long long> (Teuchos::Array<long long>::*)(long, long)) &Teuchos::Array<long long>::view, "C++: Teuchos::Array<long long>::view(long, long) --> class Teuchos::ArrayView<long long>", pybind11::arg("offset"), pybind11::arg("size_in"));
		cl.def("__call__", (class Teuchos::ArrayView<long long> (Teuchos::Array<long long>::*)(long, long)) &Teuchos::Array<long long>::operator(), "C++: Teuchos::Array<long long>::operator()(long, long) --> class Teuchos::ArrayView<long long>", pybind11::arg("offset"), pybind11::arg("size"));
		cl.def("__call__", (class Teuchos::ArrayView<long long> (Teuchos::Array<long long>::*)()) &Teuchos::Array<long long>::operator(), "C++: Teuchos::Array<long long>::operator()() --> class Teuchos::ArrayView<long long>");

		cl.def("__str__", [](Teuchos::Array<long long> const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	// Teuchos::toString(const class Teuchos::Array<int> &) file:Teuchos_Array.hpp line:1675
	M("Teuchos").def("toString", (std::string (*)(const class Teuchos::Array<int> &)) &Teuchos::toString<int>, "C++: Teuchos::toString(const class Teuchos::Array<int> &) --> std::string", pybind11::arg("array"));
	...
	{ // Teuchos::EmptyXMLError file:Teuchos_XMLObject.hpp line:55
		pybind11::class_<Teuchos::EmptyXMLError, Teuchos::RCP<Teuchos::EmptyXMLError>, PyCallBack_Teuchos_EmptyXMLError, std::runtime_error> cl(M("Teuchos"), "EmptyXMLError", "Thrown when attempting to parse an empty XML std::string.");
		cl.def( pybind11::init<const std::string &>(), pybind11::arg("what_arg") );
	...
	{ // Teuchos::XMLObject file:Teuchos_XMLObject.hpp line:62
		...
		cl.def("__str__", [](Teuchos::XMLObject const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	...
	{ // Teuchos::ParameterEntry file:Teuchos_ParameterEntry.hpp line:67
		...
		cl.def("__str__", [](Teuchos::ParameterEntry const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	...
	{ // Teuchos::FilteredIterator file:Teuchos_FilteredIterator.hpp line:60
		...
		cl.def("__str__", [](Teuchos::FilteredIterator<std::_Deque_iterator<Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry>, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> &, const Teuchos::StringIndexedOrderedValueObjectContainerBase::KeyObjectPair<Teuchos::ParameterEntry> *>,Teuchos::StringIndexedOrderedValueObjectContainerBase::SelectActive<Teuchos::ParameterEntry>> const &o) -> std::string { std::ostringstream s; s << o; return s.str(); } );
	}
	{ // Teuchos::StringIndexedOrderedValueObjectContainerBase file:Teuchos_StringIndexedOrderedValueObjectContainer.hpp line:59
		pybind11::class_<Teuchos::StringIndexedOrderedValueObjectContainerBase, Teuchos::RCP<Teuchos::StringIndexedOrderedValueObjectContainerBase>> cl(M("Teuchos"), "StringIndexedOrderedValueObjectContainerBase", "Base types for StringIndexedOrderedValueObjectContainer.");
...
;
	...
	// Teuchos::initiate(class Teuchos::ParameterList) file:Teuchos_Include.hpp line:4
